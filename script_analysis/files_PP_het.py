#!/usr/bin/python3
#
# Purpose: Merge files with prediction metrics and truth at genotype level (heterozygosity calling) for simulation study.
#
# Input
#	--in_file1	Truth files:  ../simulation/truth_het_*.txt
#	--in_file2	Metrics files: ../simulation/analysis_CAPG/PP_*het.txt files
#
# Output
#	--out_file	PR data files: simulation/analysis_CAPG/files_plot/heterozygous/PR_*_het.txt
