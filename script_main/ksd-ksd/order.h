...
int rev_uint_compare(const void *, const void *);
int rev_size_t_compare(const void *, const void *);
...
void order_uint_quicksort_with_index(unsigned int *, size_t *, size_t);
...
int compare_uint_elts(const void *, size_t *, size_t, size_t, va_list);
