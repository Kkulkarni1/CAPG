...
unsigned char **nw_seq_profile_align(char_t const * const seq, char_t const * const prof, int len1, int len2, int match, int mismatch, double gap_p, int band, int semi, int *err, unsigned int *alen, double *ascr);
