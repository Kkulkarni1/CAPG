#!/usr/bin/python3
#
# Purpose: Merge truth and metric files for calling homoeologous SNPs (homeo).
#
# Input:
#       --in_file1      Metric files: /home/peanut/peanut2/CAPG/WGS/simulation/analysis_CAPG/PL_*_Ho.txt
#       --in_file2      Truth files: /home/peanut/peanut2/CAPG/WGS/simulation/truth_homeo_*.txt
# Output: 
#       --out_file      PR data files: /home/peanut/peanut2/CAPG/WGS/simulation/analysis_CAPG/files_plot/homeologous/PR_*_homeo.txt
